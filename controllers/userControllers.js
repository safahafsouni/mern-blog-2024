...
const updateProfile = async (req, res, next) => {
  try {
    ...
    let userId = req.user._id.toString(); // Convert ObjectId to string;
    ...
    if (typeof req.body.verified !== 'undefined' && req.user.admin) {
...
const deleteUser = async (req, res, next) => {
  try {
    ...
    await await User.deleteOne({ _id: user._id });
...
// Exporting the user controller methods
module.exports = {
  registerUser,
  loginUser,
  userProfile,
